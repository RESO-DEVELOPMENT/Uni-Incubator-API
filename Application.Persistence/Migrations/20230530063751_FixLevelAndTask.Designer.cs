...
namespace Application.Persistence.Migrations
{
    ...
    [Migration("20230530063751_FixLevelAndTask")]
    partial class FixLevelAndTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Domain.Models.PayslipItemAttribute", b =>
                {
                    ...
                    b.ToTable("PayslipItemAttributes");
                });
            ...
            modelBuilder.Entity("Application.Domain.Models.ProjectEndRequest", b =>
                {
            ...
            modelBuilder.Entity("Application.Domain.Models.ProjectReportMemberAttribute", b =>
                {
                    ...
                    b.ToTable("ProjectReportMemberAttributes");
                });
            ...
            modelBuilder.Entity("Application.Domain.Models.User", b =>
                {
                    ...
                    b.Property<int>("FailedPincodeAttempt")
                        .HasColumnType("int");

                    b.Property<DateTime?>("FailedPincodeLastAttemptTime")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("PasswordChangeTokenLastSent")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Application.Domain.Models.Project", b =>
                {
                    ...
                    b.Navigation("ProjectEndRequests");
